    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          aria-hidden
        >
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_0%,rgba(2,5,186,0.08),transparent_48%),radial-gradient(circle_at_84%_10%,rgba(34,211,238,0.06),transparent_38%)]" />
          <div className="absolute inset-0 opacity-40 [background-image:linear-gradient(rgba(2,5,186,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(2,5,186,0.1)_1px,transparent_1px)] [background-size:46px_46px]" />

          <div className="relative z-10 flex h-full items-center justify-center px-6">
            <div className="relative w-full max-w-lg text-center text-foreground">
              <motion.div
