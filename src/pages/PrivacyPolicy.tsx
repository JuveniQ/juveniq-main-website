    ...
    <div className="site-shell section-pad">
      <section className="section-shell">
        <BentoGrid className="grid gap-4">
          <BentoTile className="space-y-4">
            ...
            <ScanlineHeading as="h1" className="title-lg max-w-[20ch] text-foreground">
              Privacy Policy
            </ScanlineHeading>
      ...
      <section className="section-shell section-pad">
        <BentoGrid className="grid gap-4 md:grid-cols-2">
          <BentoTile className="space-y-3">
            <h2 className="text-2xl text-foreground">1. Data We Collect</h2>
            <ul className="copy-default list-disc space-y-2 pl-5 text-muted-foreground">
              <li>Name</li>
              <li>Email address</li>
              <li>Phone number</li>
          ...
          <BentoTile className="space-y-3">
            <h2 className="text-2xl text-foreground">2. How We Use Data</h2>
            <ul className="copy-default list-disc space-y-2 pl-5 text-muted-foreground">
          ...
          <BentoTile className="space-y-3">
            <h2 className="text-2xl text-foreground">3. POPIA and Legal Basis</h2>
            <p className="copy-default text-muted-foreground">
          ...
          <BentoTile className="space-y-3">
            <h2 className="text-2xl text-foreground">4. Security, Cookies, and Analytics</h2>
            <p className="copy-default text-muted-foreground">
          ...
          <BentoTile className="space-y-3">
            <h2 className="text-2xl text-foreground">5. Retention and Service Infrastructure</h2>
            <p className="copy-default text-muted-foreground">
          ...
          <BentoTile className="space-y-3">
            <h2 className="text-2xl text-foreground">6. Your Rights and Contact</h2>
            <p className="copy-default text-muted-foreground">
      ...
      <section className="section-shell pb-8">
        <BentoTile className="space-y-2">
          <h2 className="text-2xl text-foreground">Contact for Privacy Requests</h2>
          <div className="copy-default space-y-1 text-muted-foreground">
