    ...
    <div className="site-shell section-pad">
      ...
      <section className="section-shell section-pad">
        <BentoGrid className="grid gap-4 md:grid-cols-2">
          <BentoTile className="space-y-3">
            <h2 className="text-2xl text-foreground">1. Scope of Services</h2>
            <p className="copy-default text-muted-foreground">
          ...
          <BentoTile className="space-y-3">
            <h2 className="text-2xl text-foreground">2. Client Responsibilities</h2>
            <p className="copy-default text-muted-foreground">
          ...
          <BentoTile className="space-y-3">
            <h2 className="text-2xl text-foreground">3. Fees and Payments</h2>
          ...
          <BentoTile className="space-y-3">
            <h2 className="text-2xl text-foreground">4. Refund Policy</h2>
            <p className="copy-default text-muted-foreground">
              Deposits are non-refundable once work has commenced.
            </p>
          </BentoTile>
          <BentoTile className="space-y-3">
            <h2 className="text-2xl text-foreground">5. IP Ownership and Licensing</h2>
            <p className="copy-default text-muted-foreground">
          ...
          <BentoTile className="space-y-3">
            <h2 className="text-2xl text-foreground">6. Warranty, Support, and Liability</h2>
            <p className="copy-default text-muted-foreground">
      ...
      <section className="section-shell pb-8">
        <BentoTile className="space-y-2">
          <h2 className="text-2xl text-foreground">Legal Contact</h2>
